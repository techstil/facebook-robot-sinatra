  ...
  def self.get_price(product)
    ...
    # build hash response containing 3 products
      products_elements << {
                              ...
                              :image_url => "https://www.interflora.fi/assets/r/w/306/h/306/f/products/2014/11/17/11/06/38/007-ruusuinen-unelma-1200-jpg"
                             }
      ...
      products_elements << {
                              ...
                              :image_url => "https://www.interflora.fi/assets/r/w/306/h/306/f/products/2016/03/03/01/03/40/interflora5300pieni-jpg"
                             }
      ...
      products_elements << {
                              ...
                              :image_url => "https://www.interflora.fi/assets/r/w/306/h/306/f/products/2016/02/29/12/16/44/interflora5331-1-jpg"
                             }
